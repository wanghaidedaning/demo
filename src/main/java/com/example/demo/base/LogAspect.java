...
import com.example.demo.model.enums.BusinessStatus;
import com.example.demo.model.utils.IpUtil;
...
public class LogAspect {
    ...
    private final SysOperLogMapper sysOperLogService;
...
//            String username = UserHolder.getUser().getUserName();
            ...
            // 保存操作日志
            sysOperLogService.insertSelective(sysOperLog);
        } catch (Exception ex) {
            // 记录处理日志过程中发生的异常。
            ex.printStackTrace();
        }
